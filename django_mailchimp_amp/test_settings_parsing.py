...
from django_mailchimp_amp import views


class SettingsParseTestCase(TestCase):
    '''
    Test if parsing of the settings works as intended and that it overwrites
    the defaults, but keeps them where they are not defined
    '''
    def test_confirm_default_success_message(self):
        ...
        self.assertEqual(test_settings['success_message'],
                         views.MAILCHIMP_DEFAULT_MESSAGES['success_message'])
    ...
    def test_overwrite_default_success_message(self):
        ...
        self.assertEqual(test_settings['error_member_exists'],
                         views.MAILCHIMP_DEFAULT_MESSAGES['error_member_exists'])  # noqa: E501
